...
export default class JIMScreen extends React.Component {
  ...
  static navigationOptions = {
    drawerIcon:({tintColor}) => (
      <AntDesign name='hearto' style={{fontSize:24, color:tintColor}}/>
      )
    }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        source={{uri: 'http://izumrudnoe.ru/pages/trenazhernyj-zal/'}}
